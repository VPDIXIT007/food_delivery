...
class ModelCheckoutOrder extends Model {
	...
	//dine in
	public function addOrderHistorydinein($order_id, $order_status_id, $comment = '', $notify = false, $override = false) {
		$order_info = $this->getOrder($order_id);
