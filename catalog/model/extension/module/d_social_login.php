...
class ModelExtensionModuleDSocialLogin extends Model
{
    ...
    public function getCurrentUrl($request_uri = true, $reset_uri = false)
    {
		...
		$word = 'https://demo.el-order.com/index.php?route=checkout/login';
		$correct = 'https://demo.el-order.com/index.php?route=checkout/checkout';
		
		$word1 = 'https://el-order.com/index.php?route=checkout/login';
		$correct1 = 'https://el-order.com/index.php?route=checkout/checkout';
		if(strpos($url, $word) !== false){
		$url =  str_replace($word,$correct,$url);
		} 
		
		if(strpos($url, $word1) !== false){
		$url =  str_replace($word1,$correct1,$url);
		} 
        // return current url
        return $url;
    }
