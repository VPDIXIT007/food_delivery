...
class ControllerCheckoutGuest extends Controller {
	...
	$this->session->data['ordertype'] = $this->request->post['type'];
		...
		if (isset($this->session->data['guest']['firstname'])) {
			$names = explode(' ', $this->session->data['guest']['firstname']);
			$data['firstname'] = $names[0];//$this->session->data['guest']['firstname'];
	...
	$this->session->data['ordertype'] = $this->request->post['type'];
		...
		$this->response->setOutput($this->load->view('checkout/guesttakeaway', $data));
	}
