...
class ControllerCheckoutLogin extends Controller {
	public function index() {
		...
		if(isset($this->session->data['table_id'])) {$data['tableid'] = 'yes';} else {$data['tableid'] = '';}
		...
		} else {$data['logged'] = null;}
		$data['forgotten'] = $this->url->link('account/forgotten', '', true);
		
		$data['social_media'] = $module_data = $this->load->controller('extension/module/d_social_login');
