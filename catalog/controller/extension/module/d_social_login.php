...
class ControllerExtensionModuleDSocialLogin extends Controller
{
    ...
    public function login(){
        $this->initializeSlRedirect($seller_id);
    ...
    private function initializeSlRedirect($seller_id = '')
    {
        // correct &amp; in url
        ...
        if (isset($_GET)) {
           ...
           $this->sl_redirect = isset($this->session->data['redirect_url'])? $this->session->data['redirect_url'] : $this->session->data['redirect_url'] = $this->url->link('account/account','seller_store_id='.$seller_id);
