		...
		$this->load->language('purpletree_multivendor/header');
			...
			if(isset($store_detail['store_status']) && $store_detail['multi_store_id'] == $this->config->get('config_store_id')){		
				...
				if ($this->config->get('module_purpletree_multivendor_status')) {
					...
					$data['text_table_manger'] 			= $this->language->get('text_table_manger');
					...
					$data['text_becomeseller'] 				= $this->language->get('text_becomeseller');
					$data['text_productreview'] 				= $this->language->get('text_productreview');
					...
					$data['table_manger'] 			= $this->url->link('extension/account/purpletree_multivendor/tablemanager', '', true);
						$data['productreview'] 			= $this->url->link('extension/account/purpletree_multivendor/sellerstore/productreview', '', true);
