...
class ControllerProductQuickView extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->get['seller_store_id'])) {
			$seller_id = (int)$this->request->get['seller_store_id'];
		} else {
			$seller_id = 0;
		}		
    ...
    public function fetchProduct($product_id) {
    	...
    	if ($product_info) {
			...
			$data['share'] = $this->url->link('product/product', 'product_id=' . (int)$this->request->get['product_id'],'product_id=' . (int)$this->request->get['seller_stor_id']);
