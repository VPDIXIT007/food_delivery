...
class ControllerProductSearch extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('product/search', $url.'&seller_store_id='.$sellerid)
		);
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			$results = $this->model_catalog_product->getProducts($filter_data,$sellerid);
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					...
					'href'        => $this->url->link('product/product', 'product_id=' . $result['product_id'] .'&seller_store_id='.$sellerid . $url),
			...
			$pagination->url = $this->url->link('product/search', $url . '&page={page}'.'&seller_store_id'.$sellerid);
