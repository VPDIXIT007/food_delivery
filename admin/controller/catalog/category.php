...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		// catimg
		if (isset($this->request->post['catimg'])) {
			$data['catimg'] = $this->request->post['catimg'];
		} elseif (!empty($category_info) && !empty($category_info['catimg'])) {
			$data['catimg'] = $category_info['catimg'];
		} else {
			$data['catimg'] = '';
		}
		// 
		...
		// catimg
		if (isset($this->request->post['catimg']) && is_file(DIR_IMAGE . $this->request->post['catimg'])) {
			$data['thumbCatimg'] = $this->model_tool_image->resize($this->request->post['catimg'], 100, 100);
		} elseif (!empty($category_info) && !empty($category_info['catimg']) && is_file(DIR_IMAGE . $category_info['catimg'])) {
			$data['thumbCatimg'] = $this->model_tool_image->resize($category_info['catimg'], 100, 100);
		} else {
			$data['thumbCatimg'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
		// 
