...
class ModelExtensionPurpletreeMultivendorSubcriptionplan extends Model {
		public function addSubscriptionPlan($data) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "purpletree_vendor_plan SET no_of_product = '" . (int)$data['no_of_product'] . "',no_of_slides = '" . (int)$data['no_of_slides'] . "',no_of_tables = '" . (int)$data['no_of_tables'] . "',`featured_store` = '" . (int)$data['featured_store'] . "', `joining_fee` = '" . (float)$data['joining_fee'] . "', no_of_featured_product = '" . (int)$data['no_of_featured_product'] . "', no_of_category_featured_product = '" . (int)$data['no_of_category_featured_product'] . "', subscription_price = '" . (float)$data['subscription_price'] . "', validity = '" . (int)$data['validity'] . "',status = '" . (int)$data['status'] . "',default_subscription_plan = '" . (int)$data['default_subscription_plan'] . "',enable_point_system = '" . (int)$data['enable_point_system'] . "', enable_theme_setting = '" . (int)$data['enable_theme_setting'] . "', modified_date = NOW(), created_date = NOW()");
		...
		public function editSubscriptionPlan($plan_id,$data) {
			$this->db->query("UPDATE " . DB_PREFIX . "purpletree_vendor_plan SET no_of_product = '" . (int)$data['no_of_product'] . "',no_of_slides = '" . (int)$data['no_of_slides'] . "',no_of_tables = '" . (int)$data['no_of_tables'] . "', joining_fee = '" . (float)$data['joining_fee'] . "',featured_store = '" . (int)$data['featured_store'] . "',no_of_featured_product = '" . (int)$data['no_of_featured_product'] . "',no_of_category_featured_product = '" . (int)$data['no_of_category_featured_product'] . "', subscription_price = '" . (float)$data['subscription_price'] . "', validity = '" . (int)$data['validity'] . "',status = '" . (int)$data['status'] . "',default_subscription_plan = '" . (int)$data['default_subscription_plan'] . "', modified_date = NOW(), enable_point_system = '" . (int)$data['enable_point_system'] . "', enable_theme_setting = '" . (int)$data['enable_theme_setting'] . "'  WHERE plan_id='". (int)$plan_id."'");
			//$plan_id = $this->db->getLastId();
